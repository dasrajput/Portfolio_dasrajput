        ...
        <BannerLayout>
            <div className=" px-4 py-2">
                ...
                <div className="h-16 w-full card_stylings text-xl sm:text-3xl flex gap-x-8 sm:gap-x-16 items-center justify-center text-Snow">
                    ...
                    <a className='hover:scale-125 ease-in-out duration-700' href="https://github.com/dsssingh" target='_blank' rel="noreferrer"><FaGithub /></a>
            ...
            >
                <div className='flex flex-col items-center justify-center'>
                    ...
                    <a className='underline text-Snow' target='_blank' href='https://github.com/dsssingh'>Be the one to integrate this!</a>
                </div>
            </Modal>
            <Footer />
        </BannerLayout>
